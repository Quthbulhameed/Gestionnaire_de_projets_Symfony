 ...
 */
final class Version20230709161650 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE invite DROP FOREIGN KEY invite_ibfk_1');
        $this->addSql('DROP INDEX email ON invite');
        $this->addSql('ALTER TABLE invite CHANGE email email VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE invite RENAME INDEX projet_id TO IDX_C7E210D7C18272');
        $this->addSql('ALTER TABLE invite RENAME INDEX tache_id TO IDX_C7E210D7D2235D39');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE invite CHANGE email email VARCHAR(255) DEFAULT NULL');
        $this->addSql('ALTER TABLE invite ADD CONSTRAINT invite_ibfk_1 FOREIGN KEY (email) REFERENCES user (email) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('CREATE INDEX email ON invite (email)');
        $this->addSql('ALTER TABLE invite RENAME INDEX idx_c7e210d7c18272 TO projet_id');
        $this->addSql('ALTER TABLE invite RENAME INDEX idx_c7e210d7d2235d39 TO tache_id');
